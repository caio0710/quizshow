...
export default function Home() {
    return (
        <main className="flex min-h-screen game-success">
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="w-1/2 p-6 bg-white border border-gray-200 rounded-lg shadow mt-4 mx-auto flex flex-col justify-center">
                        ...
                        <p className="mb-10 font-normal text-gray-700 dark:text-gray-400 text-center">
                            Parabéns, vocês conseguiu concluir o quiz!
                            <br />
                            <br />
                            Você pode clicar no botão abaixo para iniciar um novo jogo e ser sorteado com novas
                            perguntas para tester ainda mais seus conhecimentos.
                        </p>
                        <Link
                            href="game"
